...
/*
  Après analyse du fichier /ressources/mockoon/rental-oc.json, et lors de la requête sur la route GET suivante localhost:3001/api/rentals qui renvoie cet objet :
...
/*
  On termine en insérant le message prêt à être envoyé à la route POST suivante : localhost:3001/api/messages/
*/
INSERT INTO `MESSAGES` 
(id, rental_id, user_id, message, created_at, updated_at) 
VALUES 
(1, 1, 1, 'mon message', '2022/02/02', '2022/08/02');